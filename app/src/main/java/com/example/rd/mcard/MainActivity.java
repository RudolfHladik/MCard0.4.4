...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.content_frame, new QRFragment()).commit();
        //// drawer Toggle
        ...
        mListDataHeader.add("SALES");
        mListDataHeader.add("QR");
        ...
        mChildrenSales.add("Favourites");
        mChildrenSales.add("All shops");
